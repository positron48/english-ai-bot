...
* иконка озвучки выводится даже у тех слов, у которых озвучки нет (или ошибка озвучки)
* в бд висят некоторые слова, у которых dictionary error что озвучка не найдена, но при этом она должна была сгенерироваться через openrouter, а этого не произошло
