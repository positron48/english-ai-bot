...
func (r *Router) setupProtectedRoutes() {
	...
	r.mux.HandleFunc("/api/learning/grammar/continue-chapter", appAPIMiddleware.Wrap(auth.RequireAuth(r.handleLearningGrammarContinueChapter)))
	...
	r.mux.HandleFunc("/api/verb-training/v2/", appAPIMiddleware.Wrap(auth.RequireAuth(r.handleVerbPractice)))
	...
	r.mux.HandleFunc("/api/admin/lumi-facts/prompt-template", appAPIMiddleware.Wrap(adminAuth(r.RequirePermission(PermissionFullAccess)(r.handleAdminLumiFactsPromptTemplate))))
