...
defineProps<{
  name: 'warning' | 'sun' | 'moon' | 'book' | 'sparkles' | 'book-open' | 'refresh' | 'settings' | 'logout' | 'dashboard' | 'target' | 'chat' | 'more' | 'gear' | 'play' | 'shield' | 'arrow-left' | 'folder' | 'close' | 'chevron-down' | 'chevron-right' | 'plus' | 'magic' | 'edit' | 'trash' | 'home' | 'code' | 'database' | 'toggle' | 'menu' | 'lightbulb' | 'chart' | 'trophy' | 'list' | 'lock'
  dark?: boolean
}>()
</script>
