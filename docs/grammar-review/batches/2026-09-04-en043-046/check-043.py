...
units = [u for u in gr.inventory() if u["language"] == "en" and u["order"].startswith(("043.",)) and u["bank"] != "verbs"]
assert len(units) == 6 and sum(u["count"] for u in units) == 98
BASELINES = {
...
print('PASS: all 98 IDs/contracts, choices, theory bindings, report fingerprints, signatures and source-final equality')
