...
units = [u for u in gr.inventory() if u["language"] == "en" and u["order"].startswith(("045.",)) and u["bank"] != "verbs"]
assert len(units) == 6 and sum(u["count"] for u in units) == 91
BASELINES = {
...
print('PASS: all 91 IDs/contracts, choices, theory bindings, report fingerprints, signatures and source-final equality')
