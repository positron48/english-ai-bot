...
units = [u for u in gr.inventory() if u["language"] == "en" and u["order"].startswith(("044.",)) and u["bank"] != "verbs"]
assert len(units) == 6 and sum(u["count"] for u in units) == 97
BASELINES = {
...
print('PASS: all 97 IDs/contracts, choices, theory bindings, report fingerprints, signatures and source-final equality')
