...
units = [u for u in gr.inventory() if u["language"] == "es" and u["order"].startswith(("043.",)) and u["bank"] != "verbs"]
assert len(units) == 7 and sum(u["count"] for u in units) == 138
BASELINES = {
...
print('PASS: all 138 IDs/contracts, choices, theory bindings, report fingerprints, signatures and source-final equality')
