...
units = [u for u in gr.inventory() if u["language"] == "es" and u["order"].startswith(("042.",)) and u["bank"] != "verbs"]
assert len(units) == 7 and sum(u["count"] for u in units) == 125
BASELINES = {
...
print('PASS: all 125 IDs/contracts, choices, theory bindings, report fingerprints, signatures and source-final equality')
