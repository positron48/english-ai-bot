#!/usr/bin/env python3
"""Verify that files outside the haber/hablar/hacer/hallar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-haber-hallar-preserve.json").read_text())
