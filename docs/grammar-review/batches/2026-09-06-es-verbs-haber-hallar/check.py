#!/usr/bin/env python3
"""Evidence checks for the haber/hablar/hacer/hallar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-haber-hallar-baseline")
LEMMAS = {
    "haber": "3721968607b68ac7481c2d4a",
    "hablar": "658775d8514708b20cb700eb",
    "hacer": "5561054833e0ead9c83d9023",
    "hallar": "5f645fb0be0814de8e35682b",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-haber-hallar/checkpoints.jsonl"
