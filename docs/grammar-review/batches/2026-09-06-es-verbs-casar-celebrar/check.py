#!/usr/bin/env python3
"""Evidence checks for the casar/causar/celebrar verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-casar-celebrar-baseline")
LEMMAS = {
    "casar": "1df8a1e0640da8b514f71936",
    "causar": "d6679ce6243dfad6efdc83d1",
    "celebrar": "0a86a8f6b43d62c316aed866",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-casar-celebrar/checkpoints.jsonl"
