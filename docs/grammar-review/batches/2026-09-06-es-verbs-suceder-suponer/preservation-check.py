#!/usr/bin/env python3
"""Verify files outside the suceder/sufrir/superar/suponer batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-suceder-suponer-preserve.json").read_text())
