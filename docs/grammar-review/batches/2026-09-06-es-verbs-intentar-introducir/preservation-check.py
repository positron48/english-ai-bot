#!/usr/bin/env python3
"""Verify that files outside the intentar/interesar/interpretar/introducir batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-intentar-introducir-preserve.json").read_text())
