#!/usr/bin/env python3
"""Evidence checks for the intentar/interesar/interpretar/introducir review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-intentar-introducir-baseline")
LEMMAS = {
    "intentar": "b52c66e27fd1740b0cf82e50",
    "interesar": "8458dbafad81b0bc848e87be",
    "interpretar": "d02f2f42efdd615e9c65cfad",
    "introducir": "3feba87ffb7733de5204dcd5",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-intentar-introducir/checkpoints.jsonl"
