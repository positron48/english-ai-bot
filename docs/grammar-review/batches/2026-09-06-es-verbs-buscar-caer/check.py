#!/usr/bin/env python3
"""Evidence checks for the buscar/caber/caer verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-buscar-caer-baseline")
LEMMAS = {
    "buscar": "4fb1ebf771f833526d8d08c3",
    "caber": "b6b2fd3b090271be1c01349a",
    "caer": "b50497d414634771e08960ea",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-buscar-caer/checkpoints.jsonl"
