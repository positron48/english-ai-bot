#!/usr/bin/env python3
"""Read-only validation of the ES chapters 025–028 editorial batch against its baseline."""
import json
import pathlib
...
units = [u for u in gr.inventory() if u["language"] == "es" and u["order"].startswith(("025.", "026.", "027.", "028.")) and u["bank"] != "verbs"]
BASELINES = {
