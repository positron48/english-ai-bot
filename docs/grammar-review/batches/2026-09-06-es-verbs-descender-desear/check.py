#!/usr/bin/env python3
"""Evidence checks for the descender/describir/descubrir/desear review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-descender-desear-baseline")
LEMMAS = {'descender': 'bc41fee980eb26c0b07d7074',
 'describir': 'bd0a63a1df0cefc05ae17244',
 'descubrir': '7cb3494d2dead1b1f5220de6',
 'desear': '70f58eda0f5185eaef427fc8'}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-descender-desear/checkpoints.jsonl"
