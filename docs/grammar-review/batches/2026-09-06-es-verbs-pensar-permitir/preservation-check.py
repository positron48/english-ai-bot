#!/usr/bin/env python3
"""Verify that files outside the pensar/perder/permanecer/permitir batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-pensar-permitir-preserve.json").read_text())
