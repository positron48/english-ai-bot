#!/usr/bin/env python3
"""Evidence checks for the pensar/perder/permanecer/permitir review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-pensar-permitir-baseline")
LEMMAS = {
    "pensar": "1d46f0f3f7d16755bb8e51f0",
    "perder": "c88742d9f7edbb8c3f0b6db5",
    "permanecer": "6e5a78afc1f8871b4fcec85e",
    "permitir": "1d948b958d230cc5f670ee26",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-pensar-permitir/checkpoints.jsonl"
