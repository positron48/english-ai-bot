#!/usr/bin/env python3
"""Evidence checks for the apreciar/aprender/aprobar verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-apreciar-aprobar-baseline")
LEMMAS = {
    "apreciar": "e2f56c50386a818ecd6a999d",
    "aprender": "428032e933a18e0b99444cbe",
    "aprobar": "c43223a820f41e89682a07a0",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-apreciar-aprobar/checkpoints.jsonl"
