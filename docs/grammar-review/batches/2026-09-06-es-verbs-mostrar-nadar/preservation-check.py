#!/usr/bin/env python3
"""Verify that files outside the mostrar/mover/nacer/nadar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-mostrar-nadar-preserve.json").read_text())
