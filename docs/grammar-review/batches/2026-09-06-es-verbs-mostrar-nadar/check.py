#!/usr/bin/env python3
"""Evidence checks for the mostrar/mover/nacer/nadar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-mostrar-nadar-baseline")
LEMMAS = {
    "mostrar": "659524619570eb85e204b47a",
    "mover": "74943a889399fd11a2f20ace",
    "nacer": "fa9bfc0bf4b4e17c39e89ce6",
    "nadar": "4c26575c8a35b130e870873e",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-mostrar-nadar/checkpoints.jsonl"
