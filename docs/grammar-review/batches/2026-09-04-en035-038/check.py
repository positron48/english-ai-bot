#!/usr/bin/env python3
"""Read-only validation of the EN chapters 035–038 editorial batch against its baseline."""
import json
import pathlib
...
units = [u for u in gr.inventory() if u["language"] == "en" and u["order"].startswith(("035.", "036.", "037.", "038.")) and u["bank"] != "verbs"]
assert len(units) == 25 and sum(u["count"] for u in units) == 420
BASELINES = {
...
print('PASS: all 420 IDs/contracts, choices, theory bindings, report fingerprints, signatures and source-final equality')
