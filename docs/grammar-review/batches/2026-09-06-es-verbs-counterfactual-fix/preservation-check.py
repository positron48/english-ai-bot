#!/usr/bin/env python3
"""Verify that files outside the the counterfactual remediation batch batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-counterfactual-preserve.json").read_text())
