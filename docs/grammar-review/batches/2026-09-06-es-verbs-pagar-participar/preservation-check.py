#!/usr/bin/env python3
"""Verify that files outside the pagar/parar/parecer/participar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-pagar-participar-preserve.json").read_text())
