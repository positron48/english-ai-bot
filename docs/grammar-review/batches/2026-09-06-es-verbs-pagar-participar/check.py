#!/usr/bin/env python3
"""Evidence checks for the pagar/parar/parecer/participar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-pagar-participar-baseline")
LEMMAS = {
    "pagar": "341b209c51a2dd735d805dba",
    "parar": "4c38d6bf26ca1d6c500d25c6",
    "parecer": "e43952104c2f2a9e0236fd2d",
    "participar": "39ca6055468fcee4895fa22f",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-pagar-participar/checkpoints.jsonl"
