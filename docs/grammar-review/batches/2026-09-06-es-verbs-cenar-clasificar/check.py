#!/usr/bin/env python3
"""Evidence checks for the cenar/cerrar/clasificar verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-cenar-clasificar-baseline")
LEMMAS = {
    "cenar": "49a6cb767a3bb00df12816b7",
    "cerrar": "87d4225a1fcbd2eef445150b",
    "clasificar": "6d7f1d6d4df26e0572441de7",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-cenar-clasificar/checkpoints.jsonl"
