#!/usr/bin/env python3
"""Evidence checks for the cobrar/cocinar/coger verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-cobrar-coger-baseline")
LEMMAS = {
    "cobrar": "6fa1841f2f42f8520b186233",
    "cocinar": "116ab541cbe2e8fc62853bf5",
    "coger": "273b11c4074cfe8d0c1283cb",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-cobrar-coger/checkpoints.jsonl"
