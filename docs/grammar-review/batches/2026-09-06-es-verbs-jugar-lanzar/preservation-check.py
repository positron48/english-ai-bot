#!/usr/bin/env python3
"""Verify that files outside the jugar/juzgar/lamentar/lanzar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-jugar-lanzar-preserve.json").read_text())
