#!/usr/bin/env python3
"""Read-only validation of the ES 061-064 editorial batch against its baseline."""
...
units = [u for u in gr.inventory() if u["language"] == "es" and u["order"].startswith(("061.", "062.", "063.", "064.")) and u["bank"] != "verbs"]
