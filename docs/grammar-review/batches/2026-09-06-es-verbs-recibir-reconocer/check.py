#!/usr/bin/env python3
"""Evidence checks for the recibir/recoger/recomendar/reconocer review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-recibir-reconocer-baseline")
LEMMAS = {
    "recibir": "3e61b26f6552cec6b375d6ff",
    "recoger": "94f5b8420a855d0502df92e1",
    "recomendar": "cd26ffd7059959af16890a05",
    "reconocer": "7b94c1789b1c66e4f39a8458",
}
SCOPES = [
...
def main():
    ...
    for lemma, report_id in LEMMAS.items():
        ...
        for scope, mood, tense in SCOPES:
            ...
            assert [c["surface_form"] for c in scope_cards] == expected_forms, f"{lemma} {scope}: differs from Jehle"
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-recibir-reconocer/checkpoints.jsonl"
