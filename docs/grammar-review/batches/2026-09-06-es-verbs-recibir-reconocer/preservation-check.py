#!/usr/bin/env python3
"""Verify files outside the recibir/recoger/recomendar/reconocer batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-recibir-reconocer-preserve.json").read_text())
