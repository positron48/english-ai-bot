#!/usr/bin/env python3
"""Evidence checks for the consistir/constituir/construir verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-consistir-construir-baseline")
LEMMAS = {
    "consistir": "acfa7161f7bd524fdb45b795",
    "constituir": "489aca569133b12b2ea15fec",
    "construir": "f8098fd2f7030b791950abd1",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-consistir-construir/checkpoints.jsonl"
