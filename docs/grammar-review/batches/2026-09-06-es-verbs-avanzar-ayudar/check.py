#!/usr/bin/env python3
"""Evidence checks for the avanzar/avisar/ayudar verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-avanzar-ayudar-baseline")
LEMMAS = {
    "avanzar": "c835ca756bf2d2bff2ebb893",
    "avisar": "4f3e77b2356ab13db6f8c442",
    "ayudar": "603c2782fa02949feca16cf2",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-avanzar-ayudar/checkpoints.jsonl"
