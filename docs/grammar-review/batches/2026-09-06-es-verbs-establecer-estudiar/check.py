#!/usr/bin/env python3
"""Evidence checks for the establecer/estar/estimar/estudiar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-establecer-estudiar-baseline")
LEMMAS = {
    "establecer": "fed7cbb8de1900d8abe6abcc",
    "estar": "cd716e39c3a824f7d809e38c",
    "estimar": "8acecb2e85d4067f3d1bfba0",
    "estudiar": "0297fac9df13b3cc2e9e60aa",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-establecer-estudiar/checkpoints.jsonl"
