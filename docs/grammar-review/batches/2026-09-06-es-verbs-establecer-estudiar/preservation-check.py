#!/usr/bin/env python3
"""Verify that files outside the establecer/estar/estimar/estudiar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-establecer-estudiar-preserve.json").read_text())
