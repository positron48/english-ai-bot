#!/usr/bin/env python3
"""Evidence checks for the viajar/visitar/vivir/volar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-viajar-volar-baseline")
LEMMAS = {
    "viajar": "4b60d7ff02e794ca67a33f53",
    "visitar": "0ba68c193683a8314d608b36",
    "vivir": "219220aa6ca099996f1be1c6",
    "volar": "69b32301ca6b70c4b7025119",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [
        json.loads(line)
        for line in (ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-viajar-volar/checkpoints.jsonl").read_text().splitlines()
    ]
