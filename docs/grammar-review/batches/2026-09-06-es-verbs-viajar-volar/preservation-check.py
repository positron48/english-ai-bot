#!/usr/bin/env python3
"""Verify files outside the viajar/visitar/vivir/volar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-viajar-volar-preserve.json").read_text())
