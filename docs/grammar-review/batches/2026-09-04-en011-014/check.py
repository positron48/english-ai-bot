#!/usr/bin/env python3
"""Read-only validation of the EN chapters 011–014 editorial batch against its baseline."""
import json
import pathlib
...
units = [u for u in gr.inventory() if u["language"] == "en" and u["order"].startswith(("011.", "012.", "013.", "014.")) and u["bank"] != "verbs"]
BASELINES = {
...
print('PASS: all 390 IDs/contracts, choices, theory bindings, report fingerprints, signatures and source-final equality')
