#!/usr/bin/env python3
"""Evidence checks for the andar/anunciar/aparecer verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-andar-aparecer-baseline")
LEMMAS = {
    "andar": "0da887f8d8e7a7ac87b0fa62",
    "anunciar": "d15aa5af8e8c484f5a740a45",
    "aparecer": "89de62208d14b43c5fe8d0ec",
}
SCOPES = [
...
def main():
    ...
    for lemma, report_id in LEMMAS.items():
        ...
        # malformed andar baseline assigned the last 24 slots to the preceding
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-andar-aparecer/checkpoints.jsonl"
