#!/usr/bin/env python3
"""Read-only validation of the ES chapters 002–003 editorial batch against its baseline."""
import json
import pathlib
...
units = [u for u in gr.inventory() if u["language"] == "es" and u["order"].startswith(("002.", "003.")) and u["bank"] != "verbs"]
BASELINES = {
...
print('PASS: all 250 IDs/contracts, choices, theory bindings, report fingerprints, signatures and source-final equality')
