#!/usr/bin/env python3
"""Evidence checks for the acompañar/acordar/actuar verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-acompanar-actuar-baseline")
LEMMAS = {
    "acompañar": "7f62e70e5743a19a220a744f",
    "acordar": "b7b548ceac6a3b82717d54eb",
    "actuar": "6748c8dfd1d0b8a74de00903",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-acompanar-actuar/checkpoints.jsonl"
