#!/usr/bin/env python3
"""Evidence checks for the colocar/combatir/comentar verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-colocar-comentar-baseline")
LEMMAS = {
    "colocar": "af205b59516116b045905608",
    "combatir": "d27d03dbf3d8f3c569ca8b33",
    "comentar": "12bbfb4d5b7fdd5987345b65",
}
SCOPES = [
...
def authoritative_forms():
    ...
    comentar = [
        ["comento", "comentas", "comenta", "comentamos", "comentáis", "comentan"],
        ["comentaba", "comentabas", "comentaba", "comentábamos", "comentabais", "comentaban"],
        ...
        ["comentaría", "comentarías", "comentaría", "comentaríamos", "comentaríais", "comentarían"],
        ["he comentado", "has comentado", "ha comentado", "hemos comentado", "habéis comentado", "han comentado"],
        ["había comentado", "habías comentado", "había comentado", "habíamos comentado", "habíais comentado", "habían comentado"],
        ["hube comentado", "hubiste comentado", "hubo comentado", "hubimos comentado", "hubisteis comentado", "hubieron comentado"],
        ["habré comentado", "habrás comentado", "habrá comentado", "habremos comentado", "habréis comentado", "habrán comentado"],
        ["habría comentado", "habrías comentado", "habría comentado", "habríamos comentado", "habríais comentado", "habrían comentado"],
        ["comente", "comentes", "comente", "comentemos", "comentéis", "comenten"],
        ["comentara", "comentaras", "comentara", "comentáramos", "comentarais", "comentaran"],
        ["comentare", "comentares", "comentare", "comentáremos", "comentareis", "comentaren"],
        ["haya comentado", "hayas comentado", "haya comentado", "hayamos comentado", "hayáis comentado", "hayan comentado"],
        ["hubiera comentado", "hubieras comentado", "hubiera comentado", "hubiéramos comentado", "hubierais comentado", "hubieran comentado"],
        ["hubiere comentado", "hubieres comentado", "hubiere comentado", "hubiéremos comentado", "hubiereis comentado", "hubieren comentado"],
    ]
    for (_, mood, tense), values in zip(SCOPES, comentar):
        found[("comentar", mood, tense)] = values
    return found
...
def main():
    ...
    for lemma, report_id in LEMMAS.items():
        ...
        expected_reference = "RAE" if lemma == "comentar" else "Jehle"
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-colocar-comentar/checkpoints.jsonl"
