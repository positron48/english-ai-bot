#!/usr/bin/env python3
"""Evidence checks for the huir/importar/incluir/indicar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-huir-indicar-baseline")
LEMMAS = {
    "huir": "d4c24fd9d851f18452735371",
    "importar": "9608904fb6f78e334a82611e",
    "incluir": "bbc54f13efabcbc6eca177ad",
    "indicar": "97c74c265908a36c32df3a93",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-huir-indicar/checkpoints.jsonl"
