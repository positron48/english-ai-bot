#!/usr/bin/env python3
"""Verify that files outside the huir/importar/incluir/indicar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-huir-indicar-preserve.json").read_text())
