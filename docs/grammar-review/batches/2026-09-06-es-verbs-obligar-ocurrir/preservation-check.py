#!/usr/bin/env python3
"""Verify that files outside the obligar/obtener/ocupar/ocurrir batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-obligar-ocurrir-preserve.json").read_text())
