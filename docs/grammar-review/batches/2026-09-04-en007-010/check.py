#!/usr/bin/env python3
"""Read-only validation of the EN chapters 007–010 editorial batch against its baseline."""
import json
import pathlib
...
units = [u for u in gr.inventory() if u["language"] == "en" and u["order"].startswith(("007.", "008.", "009.", "010.")) and u["bank"] != "verbs"]
BASELINES = {
...
print('PASS: all 378 IDs/contracts, choices, theory bindings, report fingerprints, signatures and source-final equality')
