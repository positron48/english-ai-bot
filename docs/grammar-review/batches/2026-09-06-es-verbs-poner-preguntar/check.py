#!/usr/bin/env python3
"""Evidence checks for the poner/practicar/preferir/preguntar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-poner-preguntar-baseline")
LEMMAS = {
    "poner": "2b9df5aa2ccd832aef799971",
    "practicar": "313c3657478777d6ce879e64",
    "preferir": "b3e57e3f8ca6cd8f2989494c",
    "preguntar": "ffbb819362df1261cd79f111",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-poner-preguntar/checkpoints.jsonl"
