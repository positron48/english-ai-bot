#!/usr/bin/env python3
"""Verify that files outside the poner/practicar/preferir/preguntar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-poner-preguntar-preserve.json").read_text())
