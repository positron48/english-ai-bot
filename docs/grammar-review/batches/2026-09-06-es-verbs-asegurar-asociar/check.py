#!/usr/bin/env python3
"""Evidence checks for the asegurar/asistir/asociar verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-asegurar-asociar-baseline")
LEMMAS = {
    "asegurar": "df35b07b44056da534912144",
    "asistir": "a82bcec52f4bdc019b6bb08a",
    "asociar": "1fbbfc3e9fbb114a604eeb84",
}
SCOPES = [
...
RAE_ASEGURAR = [
    ["aseguro", "aseguras", "asegura", "aseguramos", "aseguráis", "aseguran"],
    ["aseguraba", "asegurabas", "aseguraba", "asegurábamos", "asegurabais", "aseguraban"],
    ["aseguré", "aseguraste", "aseguró", "aseguramos", "asegurasteis", "aseguraron"],
    ["aseguraré", "asegurarás", "asegurará", "aseguraremos", "aseguraréis", "asegurarán"],
    ["aseguraría", "asegurarías", "aseguraría", "aseguraríamos", "aseguraríais", "asegurarían"],
    ["he asegurado", "has asegurado", "ha asegurado", "hemos asegurado", "habéis asegurado", "han asegurado"],
    ["había asegurado", "habías asegurado", "había asegurado", "habíamos asegurado", "habíais asegurado", "habían asegurado"],
    ["hube asegurado", "hubiste asegurado", "hubo asegurado", "hubimos asegurado", "hubisteis asegurado", "hubieron asegurado"],
    ["habré asegurado", "habrás asegurado", "habrá asegurado", "habremos asegurado", "habréis asegurado", "habrán asegurado"],
    ["habría asegurado", "habrías asegurado", "habría asegurado", "habríamos asegurado", "habríais asegurado", "habrían asegurado"],
    ["asegure", "asegures", "asegure", "aseguremos", "aseguréis", "aseguren"],
    ["asegurara", "aseguraras", "asegurara", "aseguráramos", "asegurarais", "aseguraran"],
    ["asegurare", "asegurares", "asegurare", "aseguráremos", "asegurareis", "aseguraren"],
    ["haya asegurado", "hayas asegurado", "haya asegurado", "hayamos asegurado", "hayáis asegurado", "hayan asegurado"],
    ["hubiera asegurado", "hubieras asegurado", "hubiera asegurado", "hubiéramos asegurado", "hubierais asegurado", "hubieran asegurado"],
    ["hubiere asegurado", "hubieres asegurado", "hubiere asegurado", "hubiéremos asegurado", "hubiereis asegurado", "hubieren asegurado"],
]
...
def jehle_forms():
    ...
    for index, (_, mood, tense) in enumerate(SCOPES):
        found[("asegurar", mood, tense)] = RAE_ASEGURAR[index]
    return found
...
def main():
    ...
    for lemma, report_id in LEMMAS.items():
        ...
        reference = "RAE" if lemma == "asegurar" else "Jehle"
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-asegurar-asociar/checkpoints.jsonl"
