#!/usr/bin/env python3
"""Verify that files outside the evitar/exigir/existir/explicar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-evitar-explicar-preserve.json").read_text())
