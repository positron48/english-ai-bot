#!/usr/bin/env python3
"""Evidence checks for the admitir/advertir/afectar verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-admitir-afectar-baseline")
LEMMAS = {
    "admitir": "e8c7c65b5c5e4acbcb5385db",
    "advertir": "2f91f9a7058edd3d76945041",
    "afectar": "4887f9691e031cf9727ad2f6",
}
SCOPES = [
...
def jehle_forms():
    ...
    rae_afectar = {
        ("Indicativo", "Presente"): ["afecto", "afectas", "afecta", "afectamos", "afectáis", "afectan"],
        ("Indicativo", "Imperfecto"): ["afectaba", "afectabas", "afectaba", "afectábamos", "afectabais", "afectaban"],
        ("Indicativo", "Pretérito"): ["afecté", "afectaste", "afectó", "afectamos", "afectasteis", "afectaron"],
        ("Indicativo", "Futuro"): ["afectaré", "afectarás", "afectará", "afectaremos", "afectaréis", "afectarán"],
        ("Indicativo", "Condicional"): ["afectaría", "afectarías", "afectaría", "afectaríamos", "afectaríais", "afectarían"],
        ("Indicativo", "Pretérito perfecto"): ["he afectado", "has afectado", "ha afectado", "hemos afectado", "habéis afectado", "han afectado"],
        ("Indicativo", "Pluscuamperfecto"): ["había afectado", "habías afectado", "había afectado", "habíamos afectado", "habíais afectado", "habían afectado"],
        ("Indicativo", "Pretérito anterior"): ["hube afectado", "hubiste afectado", "hubo afectado", "hubimos afectado", "hubisteis afectado", "hubieron afectado"],
        ("Indicativo", "Futuro perfecto"): ["habré afectado", "habrás afectado", "habrá afectado", "habremos afectado", "habréis afectado", "habrán afectado"],
        ("Indicativo", "Condicional perfecto"): ["habría afectado", "habrías afectado", "habría afectado", "habríamos afectado", "habríais afectado", "habrían afectado"],
        ("Subjuntivo", "Presente"): ["afecte", "afectes", "afecte", "afectemos", "afectéis", "afecten"],
        ("Subjuntivo", "Imperfecto"): ["afectara", "afectaras", "afectara", "afectáramos", "afectarais", "afectaran"],
        ("Subjuntivo", "Futuro"): ["afectare", "afectares", "afectare", "afectáremos", "afectareis", "afectaren"],
        ("Subjuntivo", "Pretérito perfecto"): ["haya afectado", "hayas afectado", "haya afectado", "hayamos afectado", "hayáis afectado", "hayan afectado"],
        ("Subjuntivo", "Pluscuamperfecto"): ["hubiera afectado", "hubieras afectado", "hubiera afectado", "hubiéramos afectado", "hubierais afectado", "hubieran afectado"],
        ("Subjuntivo", "Futuro perfecto"): ["hubiere afectado", "hubieres afectado", "hubiere afectado", "hubiéremos afectado", "hubiereis afectado", "hubieren afectado"],
    }
    for key, values in rae_afectar.items():
        found[("afectar", *key)] = values
    return found
...
def main():
    ...
    for lemma, report_id in LEMMAS.items():
        ...
        print(f"{lemma}: PASS 96 cards, authoritative forms, contracts and report fingerprint")

    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-admitir-afectar/checkpoints.jsonl"
