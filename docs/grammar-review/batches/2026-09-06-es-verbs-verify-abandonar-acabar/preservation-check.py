#!/usr/bin/env python3
"""Verify files outside the verification abandonar/abordar/abrir/acabar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-verify-abandonar-acabar-preserve.json").read_text())
