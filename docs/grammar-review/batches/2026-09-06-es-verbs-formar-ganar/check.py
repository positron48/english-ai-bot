#!/usr/bin/env python3
"""Evidence checks for the formar/fumar/funcionar/ganar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-formar-ganar-baseline")
LEMMAS = {
    "formar": "244de9e3d39f3c79a57ac460",
    "fumar": "77f6a257ddb3cd682070cb96",
    "funcionar": "2bd03641b435937da08f284c",
    "ganar": "25e1f7b49dfb52c3b7b6b5f4",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-formar-ganar/checkpoints.jsonl"
