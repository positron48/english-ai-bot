#!/usr/bin/env python3
"""Verify that files outside the formar/fumar/funcionar/ganar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-formar-ganar-preserve.json").read_text())
