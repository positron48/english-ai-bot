#!/usr/bin/env python3
"""Read-only validation of the ES chapters 037–040 editorial batch against its baseline."""
import json
import pathlib
...
units = [u for u in gr.inventory() if u["language"] == "es" and u["order"].startswith(("037.", "038.", "039.", "040.")) and u["bank"] != "verbs"]
assert len(units) == 28 and sum(u["count"] for u in units) == 572
BASELINES = {
...
print('PASS: all 572 IDs/contracts, choices, theory bindings, report fingerprints, signatures and source-final equality')
