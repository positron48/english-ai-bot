#!/usr/bin/env python3
"""Evidence checks for the volver/votar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-volver-votar-baseline")
LEMMAS = {
    "volver": "f4f51a135f3ba670115f22ab",
    "votar": "0f29b27d2ceb3e22005b0562",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [
        json.loads(line)
        for line in (Path(__file__).resolve().parent / "checkpoints.jsonl").read_text().splitlines()
    ]
    ...
    print(f"PASS: {total} cards; 12 checkpoints; no duplicate prompt+answer signatures")
