#!/usr/bin/env python3
"""Evidence checks for the entender/entrar/entregar/enviar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-entender-enviar-baseline")
LEMMAS = {'entender': 'b79c056ea9dcadf074ac9f3f',
 'entrar': '2d0394a63e419a17e2a21f32',
 'entregar': '8205b9e901f75d34e6c33e3b',
 'enviar': '784f11f03685a10141ff35d7'}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-entender-enviar/checkpoints.jsonl"
