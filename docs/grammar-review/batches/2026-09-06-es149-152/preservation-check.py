#!/usr/bin/env python3
"""Verify that pre-existing dirty files outside the ES 149-152 batch are unchanged."""
import hashlib
import json
import subprocess
...
SNAPSHOT = json.loads(Path('/tmp/grammar-es149152-preserve.json').read_text())
...
print('preserved_total', len(SNAPSHOT))
