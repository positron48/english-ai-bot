#!/usr/bin/env python3
"""Read-only validation of the ES/EN chapter 001 editorial pilot against its baseline."""
import json
import pathlib
...
units = [u for u in gr.inventory() if u["order"].startswith("001.") and u["bank"] != "verbs"]
BASELINES = {
    "spanish-grammar": "7d0708cdd1d7c88c790f6238a82de9b903fa1ba9",
    "english-grammar": "5f9f7d14a684baa83ef4fe759bdacd0a97c4f563",
}
...
for lang,course in [('es','spanish-grammar'),('en','english-grammar')]:
...
print('PASS: all 224 IDs/contracts, choices, theory bindings, report fingerprints, signatures and source-final equality')
