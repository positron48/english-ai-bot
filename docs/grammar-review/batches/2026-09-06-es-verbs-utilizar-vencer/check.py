#!/usr/bin/env python3
"""Evidence checks for the utilizar/vaciar/valer/vencer review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-utilizar-vencer-baseline")
LEMMAS = {
    "utilizar": "488d24d58f178e8cb8c09d9e",
    "vaciar": "b65aa6678b34f66b9ad3a5b6",
    "valer": "65423599399100293e0592b1",
    "vencer": "e444f81270cf10bd9e612a9e",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [
        json.loads(line)
        for line in (ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-utilizar-vencer/checkpoints.jsonl").read_text().splitlines()
    ]
