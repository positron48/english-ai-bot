#!/usr/bin/env python3
"""Evidence checks for the informar/iniciar/insistir/instalar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-informar-instalar-baseline")
LEMMAS = {
    "informar": "e1548678294b9474ab2c31fb",
    "iniciar": "6fccf37cf2fa360dcf6f03c4",
    "insistir": "fa37b2c84fdb2b1a7f1b0236",
    "instalar": "c2f990da08df190563c1603f",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-informar-instalar/checkpoints.jsonl"
