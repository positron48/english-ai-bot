#!/usr/bin/env python3
"""Verify that files outside the informar/iniciar/insistir/instalar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-informar-instalar-preserve.json").read_text())
