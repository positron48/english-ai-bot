#!/usr/bin/env python3
"""Evidence checks for the medir/mejorar/merecer/meter review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-medir-meter-baseline")
LEMMAS = {
    "medir": "b0ef66fe1248708fdcc8e2ae",
    "mejorar": "c2c1303eed68608e8c540387",
    "merecer": "34d836608019f0f965343e0f",
    "meter": "c56ddae5e059bd8fc97c7008",
}
SCOPES = [
...
def jehle_forms():
    ...
    rae_mejorar = [
        ["mejoro", "mejoras", "mejora", "mejoramos", "mejoráis", "mejoran"],
        ["mejoraba", "mejorabas", "mejoraba", "mejorábamos", "mejorabais", "mejoraban"],
        ["mejoré", "mejoraste", "mejoró", "mejoramos", "mejorasteis", "mejoraron"],
        ["mejoraré", "mejorarás", "mejorará", "mejoraremos", "mejoraréis", "mejorarán"],
        ["mejoraría", "mejorarías", "mejoraría", "mejoraríamos", "mejoraríais", "mejorarían"],
        ["he mejorado", "has mejorado", "ha mejorado", "hemos mejorado", "habéis mejorado", "han mejorado"],
        ["había mejorado", "habías mejorado", "había mejorado", "habíamos mejorado", "habíais mejorado", "habían mejorado"],
        ["hube mejorado", "hubiste mejorado", "hubo mejorado", "hubimos mejorado", "hubisteis mejorado", "hubieron mejorado"],
        ["habré mejorado", "habrás mejorado", "habrá mejorado", "habremos mejorado", "habréis mejorado", "habrán mejorado"],
        ["habría mejorado", "habrías mejorado", "habría mejorado", "habríamos mejorado", "habríais mejorado", "habrían mejorado"],
        ["mejore", "mejores", "mejore", "mejoremos", "mejoréis", "mejoren"],
        ["mejorara", "mejoraras", "mejorara", "mejoráramos", "mejorarais", "mejoraran"],
        ["mejorare", "mejorares", "mejorare", "mejoráremos", "mejorareis", "mejoraren"],
        ["haya mejorado", "hayas mejorado", "haya mejorado", "hayamos mejorado", "hayáis mejorado", "hayan mejorado"],
        ["hubiera mejorado", "hubieras mejorado", "hubiera mejorado", "hubiéramos mejorado", "hubierais mejorado", "hubieran mejorado"],
        ["hubiere mejorado", "hubieres mejorado", "hubiere mejorado", "hubiéremos mejorado", "hubiereis mejorado", "hubieren mejorado"],
    ]
    for (_, mood, tense), values in zip(SCOPES, rae_mejorar):
        found[("mejorar", mood, tense)] = values
    return found
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-medir-meter/checkpoints.jsonl"
