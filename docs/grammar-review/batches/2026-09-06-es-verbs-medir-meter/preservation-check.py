#!/usr/bin/env python3
"""Verify that files outside the medir/mejorar/merecer/meter batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-medir-meter-preserve.json").read_text())
