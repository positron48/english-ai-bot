#!/usr/bin/env python3
"""Evidence checks for the abandonar/abordar/abrir verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-abandonar-abrir-baseline")
LEMMAS = {
    "abandonar": "f0566d23c167dd3b93172290",
    "abordar": "ca3615ffec3de616c6d263f7",
    "abrir": "d05efeee10bddf44584c3f13",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-abandonar-abrir/checkpoints.jsonl"
