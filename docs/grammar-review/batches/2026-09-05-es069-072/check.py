#!/usr/bin/env python3
"""Read-only validation of the ES 069-072 editorial batch against its baseline."""
...
units = [u for u in gr.inventory() if u["language"] == "es" and u["order"].startswith(("069.", "070.", "071.", "072.")) and u["bank"] != "verbs"]
