#!/usr/bin/env python3
"""Evidence checks for the fabricar/faltar/fijar/firmar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-fabricar-firmar-baseline")
LEMMAS = {
    "fabricar": "603cd01503ee32168eb79fc1",
    "faltar": "b71a3a905b2793944ddcbeef",
    "fijar": "e23b6d9cef05f52bf33c383c",
    "firmar": "442b5ee124f03668d68c9b51",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-fabricar-firmar/checkpoints.jsonl"
