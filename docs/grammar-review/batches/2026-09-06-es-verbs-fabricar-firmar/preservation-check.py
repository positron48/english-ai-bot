#!/usr/bin/env python3
"""Verify that files outside the fabricar/faltar/fijar/firmar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-fabricar-firmar-preserve.json").read_text())
