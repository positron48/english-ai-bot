#!/usr/bin/env python3
"""Evidence checks for the afirmar/agradecer/alcanzar verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-afirmar-alcanzar-baseline")
LEMMAS = {
    "afirmar": "3d8a6b9dfa2717b8ffb11970",
    "agradecer": "f14f851ec99e68ffe9e19f5c",
    "alcanzar": "cac1f3b103c1cfe918926785",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-afirmar-alcanzar/checkpoints.jsonl"
