#!/usr/bin/env python3
"""Evidence checks for the conseguir/conservar/considerar verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-conseguir-considerar-baseline")
LEMMAS = {
    "conseguir": "ea2ed7b5d13600031633240e",
    "conservar": "cac8acee8b2bfe8e2b3e40f3",
    "considerar": "99e7b2e2996c1284054117ff",
}
SCOPES = [
...
def authoritative_forms():
 ...
 ['consideraba', 'considerabas', 'consideraba', 'considerábamos', 'considerabais', 'consideraban'],
 ['consideré', 'consideraste', 'consideró', 'consideramos', 'considerasteis', 'consideraron'],
 ['consideraré', 'considerarás', 'considerará', 'consideraremos', 'consideraréis', 'considerarán'],
 ['consideraría', 'considerarías', 'consideraría', 'consideraríamos', 'consideraríais', 'considerarían'],
 ['he considerado', 'has considerado', 'ha considerado', 'hemos considerado', 'habéis considerado', 'han considerado'],
 ['había considerado',
  'habías considerado',
  'había considerado',
 ...
 ['habría considerado',
  ...
  'habríais considerado',
  'habrían considerado'],
 ['considere', 'consideres', 'considere', 'consideremos', 'consideréis', 'consideren'],
 ['considerara', 'consideraras', 'considerara', 'consideráramos', 'considerarais', 'consideraran'],
 ['considerare', 'considerares', 'considerare', 'consideráremos', 'considerareis', 'consideraren'],
 ['haya considerado',
  'hayas considerado',
  'haya considerado',
  'hayamos considerado',
 ...
 ['hubiere considerado',
  ...
  'hubieren considerado']]
    for (_, mood, tense), values in zip(SCOPES, considerar):
        found[('considerar', mood, tense)] = values
    return found
...
def main():
    ...
    for lemma, report_id in LEMMAS.items():
        ...
        expected_reference = "RAE" if lemma == "considerar" else "Jehle"
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-conseguir-considerar/checkpoints.jsonl"
