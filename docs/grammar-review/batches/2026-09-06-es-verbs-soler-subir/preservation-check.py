#!/usr/bin/env python3
"""Verify files outside the soler/sonar/sorprender/subir batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-soler-subir-preserve.json").read_text())
