#!/usr/bin/env python3
"""Verify that files outside the luchar/mandar/manejar/manifestar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-luchar-manifestar-preserve.json").read_text())
