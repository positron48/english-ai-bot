#!/usr/bin/env python3
"""Evidence checks for the aspirar/atacar/atender verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-aspirar-atender-baseline")
LEMMAS = {
    "aspirar": "d0b063c897b851d61bc8b9c5",
    "atacar": "db13008fc2536d620bd11d3b",
    "atender": "142716ee16e421cfa9a35ce7",
}
SCOPES = [
...
def main():
    ...
    for lemma, report_id in LEMMAS.items():
        ...
        # malformed atender baseline assigned the last 24 slots to the preceding
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-aspirar-atender/checkpoints.jsonl"
