#!/usr/bin/env python3
"""Verify that files outside the pertenecer/pesar/picar/poder batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-pertenecer-poder-preserve.json").read_text())
