#!/usr/bin/env python3
"""Evidence checks for the pertenecer/pesar/picar/poder review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-pertenecer-poder-baseline")
LEMMAS = {
    "pertenecer": "60c15df71079182b3532d3d7",
    "pesar": "e777638b9ace99fef45508e8",
    "picar": "b700cd6cbb09860e1c690e93",
    "poder": "4155389a6b00804828d8be35",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-pertenecer-poder/checkpoints.jsonl"
