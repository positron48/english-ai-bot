#!/usr/bin/env python3
"""Evidence checks for the desaparecer/desarrollar/desayunar/descansar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-desaparecer-descansar-baseline")
LEMMAS = {
    "desaparecer": "6b636eacb940224c154a8a59",
    "desarrollar": "303f4e734355c6a67270880c",
    "desayunar": "4bdf8c94c33ce5a585d8218d",
    "descansar": "81a180600542310ed749446d",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-desaparecer-descansar/checkpoints.jsonl"
