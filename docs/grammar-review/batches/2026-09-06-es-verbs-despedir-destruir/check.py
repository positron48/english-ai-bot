#!/usr/bin/env python3
"""Evidence checks for the despedir/despertar/destacar/destruir review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-despedir-destruir-baseline")
LEMMAS = {'despedir': '36a51ecd752b47cce2e3a0e6',
 'despertar': '4eb2c8d58cfec40134f8acd4',
 'destacar': 'c3587908d51c7da02760ff5e',
 'destruir': 'c18f0f9c88e79c0922f44c12'}
SCOPES = [
...
AUTHORITATIVE_FORMS = {('destacar', 'Indicativo', 'Presente'): ['destaco', 'destacas', 'destaca', 'destacamos', 'destacáis', 'destacan'],
 ('destacar', 'Indicativo', 'Imperfecto'): ['destacaba',
                                            'destacabas',
                                            'destacaba',
                                            'destacábamos',
                                            'destacabais',
                                            'destacaban'],
 ('destacar', 'Indicativo', 'Pretérito'): ['destaqué',
                                           'destacaste',
                                           'destacó',
                                           'destacamos',
                                           'destacasteis',
                                           'destacaron'],
 ('destacar', 'Indicativo', 'Futuro'): ['destacaré',
                                        'destacarás',
                                        'destacará',
                                        'destacaremos',
                                        'destacaréis',
                                        'destacarán'],
 ('destacar', 'Indicativo', 'Condicional'): ['destacaría',
                                             'destacarías',
                                             'destacaría',
                                             'destacaríamos',
                                             'destacaríais',
                                             'destacarían'],
 ('destacar', 'Indicativo', 'Pretérito perfecto'): ['he destacado',
                                                    'has destacado',
                                                    'ha destacado',
                                                    'hemos destacado',
                                                    'habéis destacado',
                                                    'han destacado'],
 ('destacar', 'Indicativo', 'Pluscuamperfecto'): ['había destacado',
                                                  'habías destacado',
                                                  'había destacado',
                                                  'habíamos destacado',
                                                  'habíais destacado',
                                                  'habían destacado'],
 ('destacar', 'Indicativo', 'Pretérito anterior'): ['hube destacado',
                                                    'hubiste destacado',
                                                    'hubo destacado',
                                                    'hubimos destacado',
                                                    'hubisteis destacado',
                                                    'hubieron destacado'],
 ('destacar', 'Indicativo', 'Futuro perfecto'): ['habré destacado',
                                                 'habrás destacado',
                                                 'habrá destacado',
                                                 'habremos destacado',
                                                 'habréis destacado',
                                                 'habrán destacado'],
 ('destacar', 'Indicativo', 'Condicional perfecto'): ['habría destacado',
                                                      'habrías destacado',
                                                      'habría destacado',
                                                      'habríamos destacado',
                                                      'habríais destacado',
                                                      'habrían destacado'],
 ('destacar', 'Subjuntivo', 'Presente'): ['destaque',
                                          'destaques',
                                          'destaque',
                                          'destaquemos',
                                          'destaquéis',
                                          'destaquen'],
 ('destacar', 'Subjuntivo', 'Imperfecto'): ['destacara',
                                            'destacaras',
                                            'destacara',
                                            'destacáramos',
                                            'destacarais',
                                            'destacaran'],
 ('destacar', 'Subjuntivo', 'Futuro'): ['destacare',
                                        'destacares',
                                        'destacare',
                                        'destacáremos',
                                        'destacareis',
                                        'destacaren'],
 ('destacar', 'Subjuntivo', 'Pretérito perfecto'): ['haya destacado',
                                                    'hayas destacado',
                                                    'haya destacado',
                                                    'hayamos destacado',
                                                    'hayáis destacado',
                                                    'hayan destacado'],
 ('destacar', 'Subjuntivo', 'Pluscuamperfecto'): ['hubiera destacado',
                                                  'hubieras destacado',
                                                  'hubiera destacado',
                                                  'hubiéramos destacado',
                                                  'hubierais destacado',
                                                  'hubieran destacado'],
 ('destacar', 'Subjuntivo', 'Futuro perfecto'): ['hubiere destacado',
                                                 'hubieres destacado',
                                                 'hubiere destacado',
                                                 'hubiéremos destacado',
                                                 'hubiereis destacado',
                                                 'hubieren destacado'],
 ('destruir', 'Subjuntivo', 'Futuro'): ['destruyere',
                                        'destruyeres',
                                        'destruyere',
                                        'destruyéremos',
                                        'destruyereis',
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-despedir-destruir/checkpoints.jsonl"
