#!/usr/bin/env python3
"""Read-only validation of the EN chapters 002–004 editorial batch against its baseline."""
import json
import pathlib
...
units = [u for u in gr.inventory() if u["language"] == "en" and u["order"].startswith(("002.", "003.", "004.")) and u["bank"] != "verbs"]
BASELINES = {
