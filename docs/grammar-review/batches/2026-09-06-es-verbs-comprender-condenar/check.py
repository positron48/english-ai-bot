#!/usr/bin/env python3
"""Evidence checks for the comprender/comunicar/condenar verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-comprender-condenar-baseline")
LEMMAS = {
    "comprender": "cb76d9be503eb98462ee6465",
    "comunicar": "952526d6c4f4fafb70a03acf",
    "condenar": "659cbd73f03460269f3439bc",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-comprender-condenar/checkpoints.jsonl"
