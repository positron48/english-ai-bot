#!/usr/bin/env python3
"""Verify that files outside the explotar/exponer/expresar/extender batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-explotar-extender-preserve.json").read_text())
