#!/usr/bin/env python3
"""Evidence checks for the explotar/exponer/expresar/extender review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-explotar-extender-baseline")
LEMMAS = {
    "explotar": "23dbec725c487b2800292ea9",
    "exponer": "c5886835dfc59cb12db7ea6b",
    "expresar": "6b1e3e4135a3936cec0a21dd",
    "extender": "2233c8afc5d1e2732f78039d",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-explotar-extender/checkpoints.jsonl"
