#!/usr/bin/env python3
"""Evidence checks for the comenzar/comer/compartir verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-comenzar-compartir-baseline")
LEMMAS = {
    "comenzar": "893ead31c180c0485ae721e1",
    "comer": "a87b869a185e33f80765d861",
    "compartir": "0ddd906b4c52b31c9183c078",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-comenzar-compartir/checkpoints.jsonl"
