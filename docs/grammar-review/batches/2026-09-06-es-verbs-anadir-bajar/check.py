#!/usr/bin/env python3
"""Evidence checks for the añadir/bailar/bajar verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-anadir-bajar-baseline")
LEMMAS = {
    "añadir": "9460af416eb70be132b89622",
    "bailar": "da24c666225e449d9f7a05d3",
    "bajar": "1e03325a6ecdcfb02087d80a",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-anadir-bajar/checkpoints.jsonl"
