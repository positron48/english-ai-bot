#!/usr/bin/env python3
"""Read-only validation of the EN chapters 023–026 editorial batch against its baseline."""
import json
import pathlib
...
units = [u for u in gr.inventory() if u["language"] == "en" and u["order"].startswith(("023.", "024.", "025.", "026.")) and u["bank"] != "verbs"]
BASELINES = {
...
print('PASS: all 385 IDs/contracts, choices, theory bindings, report fingerprints, signatures and source-final equality')
