#!/usr/bin/env python3
"""Evidence checks for the confirmar/conocer/conquistar verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-confirmar-conquistar-baseline")
LEMMAS = {
    "confirmar": "ca620e043bc708f1982f53bd",
    "conocer": "1d7e01d6494857cdd78b50f0",
    "conquistar": "db88329a376729cd974d159c",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-confirmar-conquistar/checkpoints.jsonl"
