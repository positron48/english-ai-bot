#!/usr/bin/env python3
"""Evidence checks for the cubrir/cumplir/dar/deber verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-cubrir-deber-baseline")
LEMMAS = {
    "cubrir": "5a5fea40380e2574d884a7e6",
    "cumplir": "dea0c29226023ad0cbaf2da3",
    "dar": "de12fd77a9cd2c7f1ead6964",
    "deber": "6dab1415257f80589212eb51",
}
SCOPES = [
...
def main():
    ...
    for lemma, report_id in LEMMAS.items():
        ...
        # cumplir baseline contains noncanonical tense metadata; this batch
        # deliberately repairs those coordinates.
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-cubrir-deber/checkpoints.jsonl"
