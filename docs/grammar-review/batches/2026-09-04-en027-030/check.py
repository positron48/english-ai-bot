#!/usr/bin/env python3
"""Read-only validation of the EN chapters 027–030 editorial batch against its baseline."""
import json
import pathlib
...
units = [u for u in gr.inventory() if u["language"] == "en" and u["order"].startswith(("027.", "028.", "029.", "030.")) and u["bank"] != "verbs"]
BASELINES = {
