#!/usr/bin/env python3
"""Evidence checks for the atraer/atravesar/aumentar verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-atraer-aumentar-baseline")
LEMMAS = {
    "atraer": "25645fc79f9c101949a237bf",
    "atravesar": "64326cc1c681bf3f080417f5",
    "aumentar": "687580fed1a214162fbc07a7",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-atraer-aumentar/checkpoints.jsonl"
