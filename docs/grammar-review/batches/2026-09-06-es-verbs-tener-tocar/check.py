#!/usr/bin/env python3
"""Evidence checks for the tener/terminar/tirar/tocar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-tener-tocar-baseline")
LEMMAS = {
    "tener": "c2cd2f0ccdf2c1019d8c5a45",
    "terminar": "e07e25970dc0c7ee93e6ffdd",
    "tirar": "eef9ac7d3e73e3fdbaf52b0a",
    "tocar": "e69e5cfa415c2af6156db4a8",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [
        json.loads(line)
        for line in (ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-tener-tocar/checkpoints.jsonl").read_text().splitlines()
    ]
