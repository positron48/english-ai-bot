#!/usr/bin/env python3
"""Verify files outside the tener/terminar/tirar/tocar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-tener-tocar-preserve.json").read_text())
