#!/usr/bin/env python3
"""Evidence checks for the acabar/aceptar/acercar verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-acabar-acercar-baseline")
LEMMAS = {
    "acabar": "7f938579fdbb300050b29afc",
    "aceptar": "1dc2c119af76486dcdb8988b",
    "acercar": "94810e5c4ce81e3756613144",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-acabar-acercar/checkpoints.jsonl"
