#!/usr/bin/env python3
"""Evidence checks for the sentar/sentir/ser/servir review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-sentar-servir-baseline")
LEMMAS = {
    "sentar": "dd83c369056f19661e989ea0",
    "sentir": "935bc9d7074197901b865778",
    "ser": "e293856a89e9cdb1442ef9e0",
    "servir": "c6931f5334434b915bf14af9",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [
        json.loads(line)
        for line in (ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-sentar-servir/checkpoints.jsonl").read_text().splitlines()
    ]
