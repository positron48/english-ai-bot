#!/usr/bin/env python3
"""Verify files outside the sentar/sentir/ser/servir batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-sentar-servir-preserve.json").read_text())
