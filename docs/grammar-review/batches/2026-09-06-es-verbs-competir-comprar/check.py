#!/usr/bin/env python3
"""Evidence checks for the competir/componer/comprar verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-competir-comprar-baseline")
LEMMAS = {
    "competir": "f7f64b0f7f591ae063d15d25",
    "componer": "2a4b576a58b03af93c3ee1a6",
    "comprar": "41f241c9cd63fba5fee0090e",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-competir-comprar/checkpoints.jsonl"
