#!/usr/bin/env python3
"""Evidence checks for the decidir/decir/declarar/dedicar verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-decidir-dedicar-baseline")
LEMMAS = {
    "decidir": "43216ef751585ee876bdec1c",
    "decir": "61c8265d6802fe3d71ef3004",
    "declarar": "6358070319f2c05589ac8ee6",
    "dedicar": "df9ab47aaa5a9e4fc5a1ea20",
}
SCOPES = [
...
def main():
    ...
    for lemma, report_id in LEMMAS.items():
        ...
        # decir baseline assigns the last 24 slots to preceding scopes; this
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-decidir-dedicar/checkpoints.jsonl"
