#!/usr/bin/env python3
"""Verify files outside the verification aceptar/acercar/acompañar/acordar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-verify-apreciar-asegurar-preserve.json").read_text())
