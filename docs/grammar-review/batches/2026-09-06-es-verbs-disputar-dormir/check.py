#!/usr/bin/env python3
"""Evidence checks for the disputar/distinguir/distribuir/dormir review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-disputar-dormir-baseline")
LEMMAS = {'disputar': 'b9afdc9f4925b5547538d5c3',
 'distinguir': 'aad8a769fa8c02df9d7c3a88',
 'distribuir': 'ff9c451c8a0151e37642380c',
 'dormir': '52a7f711f873e199ad7036b8'}
SCOPES = [
...
AUTHORITATIVE_FORMS = {('disputar', 'Indicativo', 'Presente'): ['disputo',
                                          'disputas',
                                          'disputa',
                                          'disputamos',
                                          'disputáis',
                                          'disputan'],
 ('disputar', 'Indicativo', 'Imperfecto'): ['disputaba',
                                            'disputabas',
                                            'disputaba',
                                            'disputábamos',
                                            'disputabais',
                                            'disputaban'],
 ('disputar', 'Indicativo', 'Pretérito'): ['disputé',
                                           'disputaste',
                                           'disputó',
                                           'disputamos',
                                           'disputasteis',
                                           'disputaron'],
 ('disputar', 'Indicativo', 'Futuro'): ['disputaré',
                                        'disputarás',
                                        'disputará',
                                        'disputaremos',
                                        'disputaréis',
                                        'disputarán'],
 ('disputar', 'Indicativo', 'Condicional'): ['disputaría',
                                             'disputarías',
                                             'disputaría',
                                             'disputaríamos',
                                             'disputaríais',
                                             'disputarían'],
 ('disputar', 'Indicativo', 'Pretérito perfecto'): ['he disputado',
                                                    'has disputado',
                                                    'ha disputado',
                                                    'hemos disputado',
                                                    'habéis disputado',
                                                    'han disputado'],
 ('disputar', 'Indicativo', 'Pluscuamperfecto'): ['había disputado',
                                                  'habías disputado',
                                                  'había disputado',
                                                  'habíamos disputado',
                                                  'habíais disputado',
                                                  'habían disputado'],
 ('disputar', 'Indicativo', 'Pretérito anterior'): ['hube disputado',
                                                    'hubiste disputado',
                                                    'hubo disputado',
                                                    'hubimos disputado',
                                                    'hubisteis disputado',
                                                    'hubieron disputado'],
 ('disputar', 'Indicativo', 'Futuro perfecto'): ['habré disputado',
                                                 'habrás disputado',
                                                 'habrá disputado',
                                                 'habremos disputado',
                                                 'habréis disputado',
                                                 'habrán disputado'],
 ('disputar', 'Indicativo', 'Condicional perfecto'): ['habría disputado',
                                                      'habrías disputado',
                                                      'habría disputado',
                                                      'habríamos disputado',
                                                      'habríais disputado',
                                                      'habrían disputado'],
 ('disputar', 'Subjuntivo', 'Presente'): ['dispute',
                                          'disputes',
                                          'dispute',
                                          'disputemos',
                                          'disputéis',
                                          'disputen'],
 ('disputar', 'Subjuntivo', 'Imperfecto'): ['disputara',
                                            'disputaras',
                                            'disputara',
                                            'disputáramos',
                                            'disputarais',
                                            'disputaran'],
 ('disputar', 'Subjuntivo', 'Futuro'): ['disputare',
                                        'disputares',
                                        'disputare',
                                        'disputáremos',
                                        'disputareis',
                                        'disputaren'],
 ('disputar', 'Subjuntivo', 'Pretérito perfecto'): ['haya disputado',
                                                    'hayas disputado',
                                                    'haya disputado',
                                                    'hayamos disputado',
                                                    'hayáis disputado',
                                                    'hayan disputado'],
 ('disputar', 'Subjuntivo', 'Pluscuamperfecto'): ['hubiera disputado',
                                                  'hubieras disputado',
                                                  'hubiera disputado',
                                                  'hubiéramos disputado',
                                                  'hubierais disputado',
                                                  'hubieran disputado'],
 ('disputar', 'Subjuntivo', 'Futuro perfecto'): ['hubiere disputado',
                                                 'hubieres disputado',
                                                 'hubiere disputado',
                                                 'hubiéremos disputado',
                                                 'hubiereis disputado',
                                                 'hubieren disputado']}
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-disputar-dormir/checkpoints.jsonl"
