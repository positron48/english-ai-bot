#!/usr/bin/env python3
"""Evidence checks for the surgir/sustituir/tardar/temer review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-surgir-temer-baseline")
LEMMAS = {
    "surgir": "1165095c71952dec10e34db0",
    "sustituir": "b98e864615d6b880483a2fb8",
    "tardar": "84bc231a65ad25585d91597c",
    "temer": "cfba4c38ddf50f6115f4c77d",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [
        json.loads(line)
        for line in (ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-surgir-temer/checkpoints.jsonl").read_text().splitlines()
    ]
