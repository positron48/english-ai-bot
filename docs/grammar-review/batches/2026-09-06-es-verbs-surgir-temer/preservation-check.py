#!/usr/bin/env python3
"""Verify files outside the surgir/sustituir/tardar/temer batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-surgir-temer-preserve.json").read_text())
