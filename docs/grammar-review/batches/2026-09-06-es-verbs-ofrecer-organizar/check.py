#!/usr/bin/env python3
"""Evidence checks for the ofrecer/olvidar/oponer/organizar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-ofrecer-organizar-baseline")
LEMMAS = {
    "ofrecer": "2d1e42d9ae78df1c6be7d665",
    "olvidar": "12b15e63fae01cbcc497e47d",
    "oponer": "ebe2f091a550ed08b07d1e42",
    "organizar": "7e6d91543859517daa02dda7",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-ofrecer-organizar/checkpoints.jsonl"
