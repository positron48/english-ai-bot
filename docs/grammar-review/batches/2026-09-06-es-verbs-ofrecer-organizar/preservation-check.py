#!/usr/bin/env python3
"""Verify that files outside the ofrecer/olvidar/oponer/organizar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-ofrecer-organizar-preserve.json").read_text())
