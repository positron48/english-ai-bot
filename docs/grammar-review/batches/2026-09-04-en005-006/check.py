#!/usr/bin/env python3
"""Read-only validation of the EN chapters 005–006 editorial batch against its baseline."""
import json
import pathlib
...
units = [u for u in gr.inventory() if u["language"] == "en" and u["order"].startswith(("005.", "006.")) and u["bank"] != "verbs"]
BASELINES = {
...
print('PASS: all 196 IDs/contracts, choices, theory bindings, report fingerprints, signatures and source-final equality')
