#!/usr/bin/env python3
"""Evidence checks for the señalar/significar/situar/sobrevivir review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-senalar-sobrevivir-baseline")
LEMMAS = {
    "señalar": "58c5052f68d663fcf95ef6a1",
    "significar": "034e7f58a02f064c3a4af6dc",
    "situar": "8c858a362880115916d3515d",
    "sobrevivir": "07176ea68abc048a6ab3de34",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [
        json.loads(line)
        for line in (ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-senalar-sobrevivir/checkpoints.jsonl").read_text().splitlines()
    ]
