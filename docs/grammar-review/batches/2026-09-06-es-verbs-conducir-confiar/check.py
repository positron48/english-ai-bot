#!/usr/bin/env python3
"""Evidence checks for the conducir/confesar/confiar verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-conducir-confiar-baseline")
LEMMAS = {
    "conducir": "4fe185014f17a906d9707035",
    "confesar": "82ffeacfe2e5252439cb33e6",
    "confiar": "248e33d374be8034d24f15b6",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-conducir-confiar/checkpoints.jsonl"
