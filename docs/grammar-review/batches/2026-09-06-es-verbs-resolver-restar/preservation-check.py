#!/usr/bin/env python3
"""Verify files outside the resolver/respetar/responder/restar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-resolver-restar-preserve.json").read_text())
