#!/usr/bin/env python3
"""Verify that files outside the producir/prohibir/prometer/proponer batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-producir-proponer-preserve.json").read_text())
