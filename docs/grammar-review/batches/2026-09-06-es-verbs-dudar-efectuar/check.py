#!/usr/bin/env python3
"""Evidence checks for the dudar/durar/echar/efectuar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-dudar-efectuar-baseline")
LEMMAS = {'dudar': '2332f95260107c327cd114f3',
 'durar': '520a751b16133d1cbdf00999',
 'echar': '2dcfce79624e4c677b0f2ddc',
 'efectuar': 'eb138478c3c1502a13167f4f'}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-dudar-efectuar/checkpoints.jsonl"
