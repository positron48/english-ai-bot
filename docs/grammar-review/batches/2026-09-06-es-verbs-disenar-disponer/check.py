#!/usr/bin/env python3
"""Evidence checks for the diseñar/disfrutar/disminuir/disponer review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-disenar-disponer-baseline")
LEMMAS = {'diseñar': 'b488908e4c8785bfd810a411',
 'disfrutar': '314ee1d185fc82b56d91566a',
 'disminuir': '4839c79308c0ffeff4db1eef',
 'disponer': '5c8f67b7f408e3047a93c674'}
SCOPES = [
...
AUTHORITATIVE_FORMS = {('disponer', 'Indicativo', 'Presente'): ['dispongo',
                                          'dispones',
                                          'dispone',
                                          'disponemos',
                                          'disponéis',
                                          'disponen'],
 ('disponer', 'Indicativo', 'Imperfecto'): ['disponía',
                                            'disponías',
                                            'disponía',
                                            'disponíamos',
                                            'disponíais',
                                            'disponían'],
 ('disponer', 'Indicativo', 'Pretérito'): ['dispuse',
                                           'dispusiste',
                                           'dispuso',
                                           'dispusimos',
                                           'dispusisteis',
                                           'dispusieron'],
 ('disponer', 'Indicativo', 'Futuro'): ['dispondré',
                                        'dispondrás',
                                        'dispondrá',
                                        'dispondremos',
                                        'dispondréis',
                                        'dispondrán'],
 ('disponer', 'Indicativo', 'Condicional'): ['dispondría',
                                             'dispondrías',
                                             'dispondría',
                                             'dispondríamos',
                                             'dispondríais',
                                             'dispondrían'],
 ('disponer', 'Indicativo', 'Pretérito perfecto'): ['he dispuesto',
                                                    'has dispuesto',
                                                    'ha dispuesto',
                                                    'hemos dispuesto',
                                                    'habéis dispuesto',
                                                    'han dispuesto'],
 ('disponer', 'Indicativo', 'Pluscuamperfecto'): ['había dispuesto',
                                                  'habías dispuesto',
                                                  'había dispuesto',
                                                  'habíamos dispuesto',
                                                  'habíais dispuesto',
                                                  'habían dispuesto'],
 ('disponer', 'Indicativo', 'Pretérito anterior'): ['hube dispuesto',
                                                    'hubiste dispuesto',
                                                    'hubo dispuesto',
                                                    'hubimos dispuesto',
                                                    'hubisteis dispuesto',
                                                    'hubieron dispuesto'],
 ('disponer', 'Indicativo', 'Futuro perfecto'): ['habré dispuesto',
                                                 'habrás dispuesto',
                                                 'habrá dispuesto',
                                                 'habremos dispuesto',
                                                 'habréis dispuesto',
                                                 'habrán dispuesto'],
 ('disponer', 'Indicativo', 'Condicional perfecto'): ['habría dispuesto',
                                                      'habrías dispuesto',
                                                      'habría dispuesto',
                                                      'habríamos dispuesto',
                                                      'habríais dispuesto',
                                                      'habrían dispuesto'],
 ('disponer', 'Subjuntivo', 'Presente'): ['disponga',
                                          'dispongas',
                                          'disponga',
                                          'dispongamos',
                                          'dispongáis',
                                          'dispongan'],
 ('disponer', 'Subjuntivo', 'Imperfecto'): ['dispusiera',
                                            'dispusieras',
                                            'dispusiera',
                                            'dispusiéramos',
                                            'dispusierais',
                                            'dispusieran'],
 ('disponer', 'Subjuntivo', 'Futuro'): ['dispusiere',
                                        'dispusieres',
                                        'dispusiere',
                                        'dispusiéremos',
                                        'dispusiereis',
                                        'dispusieren'],
 ('disponer', 'Subjuntivo', 'Pretérito perfecto'): ['haya dispuesto',
                                                    'hayas dispuesto',
                                                    'haya dispuesto',
                                                    'hayamos dispuesto',
                                                    'hayáis dispuesto',
                                                    'hayan dispuesto'],
 ('disponer', 'Subjuntivo', 'Pluscuamperfecto'): ['hubiera dispuesto',
                                                  'hubieras dispuesto',
                                                  'hubiera dispuesto',
                                                  'hubiéramos dispuesto',
                                                  'hubierais dispuesto',
                                                  'hubieran dispuesto'],
 ('disponer', 'Subjuntivo', 'Futuro perfecto'): ['hubiere dispuesto',
                                                 'hubieres dispuesto',
                                                 'hubiere dispuesto',
                                                 'hubiéremos dispuesto',
                                                 'hubiereis dispuesto',
                                                 'hubieren dispuesto']}
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-disenar-disponer/checkpoints.jsonl"
