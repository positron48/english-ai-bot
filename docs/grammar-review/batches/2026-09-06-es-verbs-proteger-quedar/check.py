#!/usr/bin/env python3
"""Evidence checks for the proteger/provocar/publicar/quedar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-proteger-quedar-baseline")
LEMMAS = {
    "proteger": "a6d2947eafa9719fa18d431b",
    "provocar": "0e0a73cfd2a3b2e1797e97b5",
    "publicar": "e6544b74b0ca554ea8a20ea6",
    "quedar": "1e7a0f69dc36629a08882389",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-proteger-quedar/checkpoints.jsonl"
