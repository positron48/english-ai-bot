#!/usr/bin/env python3
"""Verify that files outside the proteger/provocar/publicar/quedar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-proteger-quedar-preserve.json").read_text())
