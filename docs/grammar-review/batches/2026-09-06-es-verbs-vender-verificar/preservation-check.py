#!/usr/bin/env python3
"""Verify files outside the vender/venir/ver/verificar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-vender-verificar-preserve.json").read_text())
