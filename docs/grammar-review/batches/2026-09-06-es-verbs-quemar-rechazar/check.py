#!/usr/bin/env python3
"""Evidence checks for the quemar/querer/realizar/rechazar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-quemar-rechazar-baseline")
LEMMAS = {
    "quemar": "a2fe5f3b244a76e5f4d0d5b8",
    "querer": "7a2df82aa6774fc874cfbbac",
    "realizar": "b508dfe263064403d8060859",
    "rechazar": "cfba7e06db0bdaf856b97b69",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-quemar-rechazar/checkpoints.jsonl"
