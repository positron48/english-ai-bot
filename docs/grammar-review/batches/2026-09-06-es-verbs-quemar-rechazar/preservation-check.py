#!/usr/bin/env python3
"""Verify files outside the quemar/querer/realizar/rechazar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-quemar-rechazar-preserve.json").read_text())
