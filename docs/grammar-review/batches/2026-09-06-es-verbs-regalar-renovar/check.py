#!/usr/bin/env python3
"""Evidence checks for the regalar/registrar/regresar/renovar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-regalar-renovar-baseline")
LEMMAS = {
    "regalar": "9af51af4f3b90efc70b193d7",
    "registrar": "c426b044c74cb3333847a6d9",
    "regresar": "600e4bdfec86729392cff9aa",
    "renovar": "1b5a3f0b0c5aaef5a01db08e",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-regalar-renovar/checkpoints.jsonl"
