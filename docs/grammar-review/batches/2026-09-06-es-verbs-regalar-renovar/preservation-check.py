#!/usr/bin/env python3
"""Verify files outside the regalar/registrar/regresar/renovar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-regalar-renovar-preserve.json").read_text())
