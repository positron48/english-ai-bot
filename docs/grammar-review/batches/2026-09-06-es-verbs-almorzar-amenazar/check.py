#!/usr/bin/env python3
"""Evidence checks for the almorzar/alquilar/amenazar verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-almorzar-amenazar-baseline")
LEMMAS = {
    "almorzar": "89392692d12dcc3bc9dbf0c5",
    "alquilar": "6097fcbb0eedc24adc99e46f",
    "amenazar": "1c0f9a97e4b6a9775de24b00",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-almorzar-amenazar/checkpoints.jsonl"
