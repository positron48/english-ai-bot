#!/usr/bin/env python3
"""Evidence checks for the llegar/llevar/llover/lograr review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-llegar-lograr-baseline")
LEMMAS = {
    "llegar": "60b78f2332a49ac9d5d30b78",
    "llevar": "bce9d50befec3e09ecf71b67",
    "llover": "9d41dcb08234185a950d42a3",
    "lograr": "c0ac3b6c037f69eefec79636",
}
SCOPES = [
...
def jehle_forms():
    ...
    rae_llover = [
        ...
        ["llovía", "llovías", "llovía", "llovíamos", "llovíais", "llovían"],
        ["lloví", "lloviste", "llovió", "llovimos", "llovisteis", "llovieron"],
        ["lloveré", "lloverás", "lloverá", "lloveremos", "lloveréis", "lloverán"],
        ["llovería", "lloverías", "llovería", "lloveríamos", "lloveríais", "lloverían"],
        ["he llovido", "has llovido", "ha llovido", "hemos llovido", "habéis llovido", "han llovido"],
        ["había llovido", "habías llovido", "había llovido", "habíamos llovido", "habíais llovido", "habían llovido"],
        ["hube llovido", "hubiste llovido", "hubo llovido", "hubimos llovido", "hubisteis llovido", "hubieron llovido"],
        ["habré llovido", "habrás llovido", "habrá llovido", "habremos llovido", "habréis llovido", "habrán llovido"],
        ["habría llovido", "habrías llovido", "habría llovido", "habríamos llovido", "habríais llovido", "habrían llovido"],
        ["llueva", "lluevas", "llueva", "llovamos", "llováis", "lluevan"],
        ["lloviera", "llovieras", "lloviera", "lloviéramos", "llovierais", "llovieran"],
        ["lloviere", "llovieres", "lloviere", "lloviéremos", "lloviereis", "llovieren"],
        ["haya llovido", "hayas llovido", "haya llovido", "hayamos llovido", "hayáis llovido", "hayan llovido"],
        ["hubiera llovido", "hubieras llovido", "hubiera llovido", "hubiéramos llovido", "hubierais llovido", "hubieran llovido"],
        ["hubiere llovido", "hubieres llovido", "hubiere llovido", "hubiéremos llovido", "hubiereis llovido", "hubieren llovido"],
    ]
    for (_, mood, tense), values in zip(SCOPES, rae_llover):
        found[("llover", mood, tense)] = values
    return found
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-llegar-lograr/checkpoints.jsonl"
