#!/usr/bin/env python3
"""Verify that files outside the llegar/llevar/llover/lograr batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-llegar-lograr-preserve.json").read_text())
