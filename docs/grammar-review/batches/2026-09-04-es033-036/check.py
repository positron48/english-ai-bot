#!/usr/bin/env python3
"""Read-only validation of the ES chapters 033–036 editorial batch against its baseline."""
import json
import pathlib
...
units = [u for u in gr.inventory() if u["language"] == "es" and u["order"].startswith(("033.", "034.", "035.", "036.")) and u["bank"] != "verbs"]
assert len(units) == 28 and sum(u["count"] for u in units) == 549
BASELINES = {
...
print('PASS: all 549 IDs/contracts, choices, theory bindings, report fingerprints, signatures and source-final equality')
