#!/usr/bin/env python3
"""Evidence checks for the necesitar/negar/negociar/nevar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-necesitar-nevar-baseline")
LEMMAS = {
    "necesitar": "c9132141d85a176833dedf77",
    "negar": "eaa42d978c601b3df75b11de",
    "negociar": "bc8ce09a03d58a66527aded2",
    "nevar": "003e45098ca17e25816f75f4",
}
SCOPES = [
...
def jehle_forms():
    ...
    rae_nevar = [
        ...
        ["nevaba", "nevabas", "nevaba", "nevábamos", "nevabais", "nevaban"],
        ["nevé", "nevaste", "nevó", "nevamos", "nevasteis", "nevaron"],
        ["nevaré", "nevarás", "nevará", "nevaremos", "nevaréis", "nevarán"],
        ["nevaría", "nevarías", "nevaría", "nevaríamos", "nevaríais", "nevarían"],
        ["he nevado", "has nevado", "ha nevado", "hemos nevado", "habéis nevado", "han nevado"],
        ["había nevado", "habías nevado", "había nevado", "habíamos nevado", "habíais nevado", "habían nevado"],
        ["hube nevado", "hubiste nevado", "hubo nevado", "hubimos nevado", "hubisteis nevado", "hubieron nevado"],
        ["habré nevado", "habrás nevado", "habrá nevado", "habremos nevado", "habréis nevado", "habrán nevado"],
        ["habría nevado", "habrías nevado", "habría nevado", "habríamos nevado", "habríais nevado", "habrían nevado"],
        ["nieve", "nieves", "nieve", "nevemos", "nevéis", "nieven"],
        ["nevara", "nevaras", "nevara", "neváramos", "nevarais", "nevaran"],
        ["nevare", "nevares", "nevare", "neváremos", "nevareis", "nevaren"],
        ["haya nevado", "hayas nevado", "haya nevado", "hayamos nevado", "hayáis nevado", "hayan nevado"],
        ["hubiera nevado", "hubieras nevado", "hubiera nevado", "hubiéramos nevado", "hubierais nevado", "hubieran nevado"],
        ["hubiere nevado", "hubieres nevado", "hubiere nevado", "hubiéremos nevado", "hubiereis nevado", "hubieren nevado"],
    ]
    for (_, mood, tense), values in zip(SCOPES, rae_nevar):
        found[("nevar", mood, tense)] = values
    return found
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-necesitar-nevar/checkpoints.jsonl"
