#!/usr/bin/env python3
"""Verify that files outside the necesitar/negar/negociar/nevar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-necesitar-nevar-preserve.json").read_text())
