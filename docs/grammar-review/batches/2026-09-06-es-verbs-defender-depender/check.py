#!/usr/bin/env python3
"""Evidence checks for the defender/dejar/demostrar/depender verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-defender-depender-baseline")
LEMMAS = {
    "defender": "e7d917d423a3147a505f307b",
    "dejar": "ddc6a09489ae66b958bb4d74",
    "demostrar": "6dc7932db3a539de24ac6c8d",
    "depender": "15484fa9e14718980993f379",
}
SCOPES = [
...
def main():
    ...
    for lemma, report_id in LEMMAS.items():
        ...
        # demostrar baseline assigns the last 24 slots to preceding scopes; this
        # batch deliberately repairs those coordinates.
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-defender-depender/checkpoints.jsonl"
