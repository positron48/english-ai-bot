#!/usr/bin/env python3
"""Read-only validation of the ES chapters 049–052 editorial batch against its baseline."""
import json
import pathlib
...
units = [u for u in gr.inventory() if u["language"] == "es" and u["order"].startswith(("049.", "050.", "051.", "052.")) and u["bank"] != "verbs"]
