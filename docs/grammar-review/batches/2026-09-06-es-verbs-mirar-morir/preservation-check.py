#!/usr/bin/env python3
"""Verify that files outside the mirar/modificar/montar/morir batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-mirar-morir-preserve.json").read_text())
