#!/usr/bin/env python3
"""Evidence checks for the mirar/modificar/montar/morir review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-mirar-morir-baseline")
LEMMAS = {
    "mirar": "375b3bd01e3bb3ba2e3b33da",
    "modificar": "afb268fd06587659ea334c3f",
    "montar": "f887e3a21a0f80298d64d9fa",
    "morir": "ef85afe8a75d7fcb6dc196e5",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-mirar-morir/checkpoints.jsonl"
