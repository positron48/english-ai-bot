#!/usr/bin/env python3
"""Evidence checks for the leer/levantar/limpiar/llamar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-leer-llamar-baseline")
LEMMAS = {
    "leer": "e80725023ff209a6efb60355",
    "levantar": "f18f2bb22a58d46a28446295",
    "limpiar": "a8cc2f75bdbf030033e3e2b4",
    "llamar": "9a072b3d872083a13faa1bf5",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-leer-llamar/checkpoints.jsonl"
