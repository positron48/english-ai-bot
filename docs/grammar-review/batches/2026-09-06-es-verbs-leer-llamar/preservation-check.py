#!/usr/bin/env python3
"""Verify that files outside the leer/levantar/limpiar/llamar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-leer-llamar-preserve.json").read_text())
