#!/usr/bin/env python3
"""Evidence checks for the continuar/contribuir/controlar verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-continuar-controlar-baseline")
LEMMAS = {
    "continuar": "fafd19e4863331ae497fbe27",
    "contribuir": "efc818d4c5baefb59df62b85",
    "controlar": "7dd592e616ef8bd48bb54a1a",
}
SCOPES = [
...
def main():
    ...
    for lemma, report_id in LEMMAS.items():
        ...
        # malformed controlar baseline assigned the last 24 slots to the wrong
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-continuar-controlar/checkpoints.jsonl"
