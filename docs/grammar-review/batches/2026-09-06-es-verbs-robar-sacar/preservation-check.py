#!/usr/bin/env python3
"""Verify files outside the robar/romper/saber/sacar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-robar-sacar-preserve.json").read_text())
