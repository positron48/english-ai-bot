#!/usr/bin/env python3
"""Evidence checks for the robar/romper/saber/sacar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-robar-sacar-baseline")
LEMMAS = {
    "robar": "1dc60b5c2a312ed214069f6f",
    "romper": "2e25197d11e6d8cc66d7a6d9",
    "saber": "f65846161e662c9fb30e4708",
    "sacar": "bc74ad5ad7731201a9980119",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [
        json.loads(line)
        for line in (ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-robar-sacar/checkpoints.jsonl").read_text().splitlines()
    ]
