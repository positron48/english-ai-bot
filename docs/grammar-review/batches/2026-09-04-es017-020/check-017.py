#!/usr/bin/env python3
"""Read-only validation of the ES chapter 017 editorial batch against its baseline."""
import json
import pathlib
...
units = [u for u in gr.inventory() if u["language"] == "es" and u["order"].startswith(("017.",)) and u["bank"] != "verbs"]
BASELINES = {
