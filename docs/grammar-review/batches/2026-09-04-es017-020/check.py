#!/usr/bin/env python3
"""Read-only validation of the ES chapters 017–020 editorial batch against its baseline."""
import json
import pathlib
...
units = [u for u in gr.inventory() if u["language"] == "es" and u["order"].startswith(("017.", "018.", "019.", "020.")) and u["bank"] != "verbs"]
BASELINES = {
...
print('PASS: all 561 IDs/contracts, choices, theory bindings, report fingerprints, signatures and source-final equality')
