#!/usr/bin/env python3
"""Evidence checks for the detener/devolver/devorar/dirigir review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-detener-dirigir-baseline")
LEMMAS = {'detener': '976f95e251fc494b92748031',
 'devolver': 'd874eaa075c57c3bf8450d37',
 'devorar': '0e27d1657226bd0a0dec2f05',
 'dirigir': '29aa2ad21696991373d7481e'}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-detener-dirigir/checkpoints.jsonl"
