#!/usr/bin/env python3
"""Evidence checks for the aplicar/apostar/apoyar verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-aplicar-apoyar-baseline")
LEMMAS = {
    "aplicar": "920aef2eb16b243a945f39e1",
    "apostar": "783da360bf746916a9b697de",
    "apoyar": "10d25122aafc2b328ebab030",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-aplicar-apoyar/checkpoints.jsonl"
