#!/usr/bin/env python3
"""Evidence checks for the tratar/ubicar/unir/usar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-tratar-usar-baseline")
LEMMAS = {
    "tratar": "57dd45035b8c930a1964f256",
    "ubicar": "4fc768eda02937b2a58da37b",
    "unir": "20a4c9e6ccb318edb73735ee",
    "usar": "b1db259a5177a3019a08a415",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [
        json.loads(line)
        for line in (ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-tratar-usar/checkpoints.jsonl").read_text().splitlines()
    ]
