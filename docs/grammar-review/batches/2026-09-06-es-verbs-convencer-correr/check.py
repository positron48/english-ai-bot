#!/usr/bin/env python3
"""Evidence checks for the convencer/convertir/copiar/correr verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-convencer-correr-baseline")
LEMMAS = {
    "convencer": "532f9e768920ba32d7678bae",
    "convertir": "861406c16fb5f2a695bd8213",
    "copiar": "a1493d03bd1b4cf1b43a68fb",
    "correr": "0c1290a2e2b648dd7cf03c4d",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-convencer-correr/checkpoints.jsonl"
