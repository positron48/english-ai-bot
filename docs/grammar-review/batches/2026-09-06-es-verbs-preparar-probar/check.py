#!/usr/bin/env python3
"""Evidence checks for the preparar/presentar/prever/probar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-preparar-probar-baseline")
LEMMAS = {
    "preparar": "d80874c1308886099e001f2f",
    "presentar": "4b4b404e376c113061371964",
    "prever": "3935e14fcfe001b2e0f1f823",
    "probar": "9f28df9e578d5ecda8d302ae",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-preparar-probar/checkpoints.jsonl"
