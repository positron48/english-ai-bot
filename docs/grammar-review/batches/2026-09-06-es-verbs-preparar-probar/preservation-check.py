#!/usr/bin/env python3
"""Verify that files outside the preparar/presentar/prever/probar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-preparar-probar-preserve.json").read_text())
