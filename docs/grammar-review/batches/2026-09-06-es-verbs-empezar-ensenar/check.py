#!/usr/bin/env python3
"""Evidence checks for the empezar/emplear/encontrar/enseñar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-empezar-ensenar-baseline")
LEMMAS = {'empezar': '0886b1c6af38b942057d0fde',
 'emplear': 'eb59d609b78b239d70516bb1',
 'encontrar': '7f77e133fafdba548ac8dc6e',
 'enseñar': 'd7be75b8f534b5cbfc96fdf6'}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-empezar-ensenar/checkpoints.jsonl"
