#!/usr/bin/env python3
"""Evidence checks for the consumir/contar/contener verb-form review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-consumir-contener-baseline")
LEMMAS = {
    "consumir": "1747dda33873c417515a1b99",
    "contar": "85f3e6254d95e8b07181a3d8",
    "contener": "ef495dc8592adda1a64394f3",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-consumir-contener/checkpoints.jsonl"
