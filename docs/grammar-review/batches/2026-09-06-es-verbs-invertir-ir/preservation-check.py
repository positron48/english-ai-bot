#!/usr/bin/env python3
"""Verify that files outside the invertir/investigar/invitar/ir batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-invertir-ir-preserve.json").read_text())
