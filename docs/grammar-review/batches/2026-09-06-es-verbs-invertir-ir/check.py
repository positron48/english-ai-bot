#!/usr/bin/env python3
"""Evidence checks for the invertir/investigar/invitar/ir review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-invertir-ir-baseline")
LEMMAS = {
    "invertir": "a6d8b8947e5e1c68841f933a",
    "investigar": "854f4d6e60b1c2917ca81083",
    "invitar": "2647256e751ebe3968fdd07a",
    "ir": "06a213ba4dc6f1147a70453f",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-invertir-ir/checkpoints.jsonl"
