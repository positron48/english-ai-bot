#!/usr/bin/env python3
"""Read-only validation of the EN chapters 015–018 editorial batch against its baseline."""
import json
import pathlib
...
units = [u for u in gr.inventory() if u["language"] == "en" and u["order"].startswith(("015.", "016.", "017.", "018.")) and u["bank"] != "verbs"]
BASELINES = {
    "spanish-grammar": "7d0708cdd1d7c88c790f6238a82de9b903fa1ba9",
...
print('PASS: all 395 IDs/contracts, choices, theory bindings, report fingerprints, signatures and source-final equality')
