#!/usr/bin/env python3
"""Evidence checks for the escoger/escribir/escuchar/esperar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-escoger-esperar-baseline")
LEMMAS = {
    "escoger": "b7865e46bee1599bcfc8bdcc",
    "escribir": "09c93358ea0aaedf3f334a04",
    "escuchar": "4cff5f19bfb1240650f26170",
    "esperar": "9d2998cba0dadf23298c8cf3",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-escoger-esperar/checkpoints.jsonl"
