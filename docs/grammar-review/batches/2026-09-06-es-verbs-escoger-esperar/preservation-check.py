#!/usr/bin/env python3
"""Verify that files outside the escoger/escribir/escuchar/esperar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-escoger-esperar-preserve.json").read_text())
