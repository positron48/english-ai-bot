#!/usr/bin/env python3
"""Read-only validation of the ES chapters 045–048 editorial batch against its baseline."""
import json
import pathlib
...
units = [u for u in gr.inventory() if u["language"] == "es" and u["order"].startswith(("045.", "046.", "047.", "048.")) and u["bank"] != "verbs"]
assert len(units) == 28 and sum(u["count"] for u in units) == 536
BASELINES = {
...
print('PASS: all 536 IDs/contracts, choices, theory bindings, report fingerprints, signatures and source-final equality')
