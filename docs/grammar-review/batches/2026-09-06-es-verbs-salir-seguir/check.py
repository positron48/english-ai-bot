#!/usr/bin/env python3
"""Evidence checks for the salir/saltar/salvar/seguir review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-salir-seguir-baseline")
LEMMAS = {
    "salir": "fefeb799c5be5d46a2ecf16a",
    "saltar": "76cb5333a99d486c814e57c4",
    "salvar": "39f5295a1def777f3e49a116",
    "seguir": "ddbdecb51339985525636f43",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [
        json.loads(line)
        for line in (ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-salir-seguir/checkpoints.jsonl").read_text().splitlines()
    ]
