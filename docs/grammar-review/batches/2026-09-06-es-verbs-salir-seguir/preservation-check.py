#!/usr/bin/env python3
"""Verify files outside the salir/saltar/salvar/seguir batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-salir-seguir-preserve.json").read_text())
