#!/usr/bin/env python3
"""Verify files outside the resultar/reunir/revelar/reír batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-resultar-reir-preserve.json").read_text())
