#!/usr/bin/env python3
"""Read-only validation of the ES chapters 021–024 editorial batch against its baseline."""
import json
import pathlib
...
units = [u for u in gr.inventory() if u["language"] == "es" and u["order"].startswith(("021.", "022.", "023.", "024.")) and u["bank"] != "verbs"]
BASELINES = {
...
print('PASS: all 525 IDs/contracts, choices, theory bindings, report fingerprints, signatures and source-final equality')
