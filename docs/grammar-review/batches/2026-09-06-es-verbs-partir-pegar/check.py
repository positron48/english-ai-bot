#!/usr/bin/env python3
"""Evidence checks for the partir/pasar/pedir/pegar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-partir-pegar-baseline")
LEMMAS = {
    "partir": "7a8eb35a3408c2b488f4822f",
    "pasar": "ac9be09d3f339f437ab8d609",
    "pedir": "c3ebc0528b4352f6675b2451",
    "pegar": "5bb821f5dccbc04a98b4550c",
}
SCOPES = [
...
def jehle_forms():
    ...
    rae_partir = [
        ...
        ["hubiera partido", "hubieras partido", "hubiera partido", "hubiéramos partido", "hubierais partido", "hubieran partido"],
        ["hubiere partido", "hubieres partido", "hubiere partido", "hubiéremos partido", "hubiereis partido", "hubieren partido"],
    ]
    for (_, mood, tense), values in zip(SCOPES, rae_partir):
        found[("partir", mood, tense)] = values
    return found
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-partir-pegar/checkpoints.jsonl"
