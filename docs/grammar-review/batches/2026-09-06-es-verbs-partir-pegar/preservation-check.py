#!/usr/bin/env python3
"""Verify that files outside the partir/pasar/pedir/pegar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-partir-pegar-preserve.json").read_text())
