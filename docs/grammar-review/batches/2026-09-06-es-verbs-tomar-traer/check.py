#!/usr/bin/env python3
"""Evidence checks for the tomar/trabajar/traducir/traer review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-tomar-traer-baseline")
LEMMAS = {
    "tomar": "c54a1ff1e967a0157ebf0985",
    "trabajar": "1583497b3732da11f8d7ac63",
    "traducir": "ab5cc0c48e2fda9a01a5924b",
    "traer": "9bc7be7a5dc2cbfe3d238c07",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [
        json.loads(line)
        for line in (ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-tomar-traer/checkpoints.jsonl").read_text().splitlines()
    ]
