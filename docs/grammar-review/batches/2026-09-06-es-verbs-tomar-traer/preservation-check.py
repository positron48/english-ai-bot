#!/usr/bin/env python3
"""Verify files outside the tomar/trabajar/traducir/traer batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-tomar-traer-preserve.json").read_text())
