#!/usr/bin/env python3
"""Verify that files outside the gobernar/guardar/guiar/gustar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-gobernar-gustar-preserve.json").read_text())
