#!/usr/bin/env python3
"""Evidence checks for the gobernar/guardar/guiar/gustar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-gobernar-gustar-baseline")
LEMMAS = {
    "gobernar": "4605f328a5e226a855b4dda9",
    "guardar": "5ca1f677e6997f673ddb2743",
    "guiar": "4c8b91add9b52f5b95d22674",
    "gustar": "1bb2e920d17a34ecc25d4ac2",
}
SCOPES = [
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-gobernar-gustar/checkpoints.jsonl"
