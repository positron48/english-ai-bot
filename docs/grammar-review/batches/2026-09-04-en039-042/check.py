#!/usr/bin/env python3
"""Read-only validation of the EN chapters 039–042 editorial batch against its baseline."""
import json
import pathlib
...
units = [u for u in gr.inventory() if u["language"] == "en" and u["order"].startswith(("039.", "040.", "041.", "042.")) and u["bank"] != "verbs"]
assert len(units) == 24 and sum(u["count"] for u in units) == 381
BASELINES = {
...
print('PASS: all 381 IDs/contracts, choices, theory bindings, report fingerprints, signatures and source-final equality')
