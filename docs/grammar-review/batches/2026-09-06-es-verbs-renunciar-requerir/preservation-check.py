#!/usr/bin/env python3
"""Verify files outside the renunciar/repetir/representar/requerir batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-renunciar-requerir-preserve.json").read_text())
