#!/usr/bin/env python3
"""Evidence checks for the renunciar/repetir/representar/requerir review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-renunciar-requerir-baseline")
LEMMAS = {
    "renunciar": "a36538e212b1adac2cf31591",
    "repetir": "f777f61f3e1e0007a65ab810",
    "representar": "5d9f972e37650431a44c1c37",
    "requerir": "a5e611bf4f9f1992dc949445",
}
SCOPES = [
...
def reference_forms():
    ...
    # representar is absent from Jehle. These regular -ar rows are checked
    # against the official RAE DLE conjugation table.
    rows = [
        ["represento", "representas", "representa", "representamos", "representáis", "representan"],
        ["representaba", "representabas", "representaba", "representábamos", "representabais", "representaban"],
        ["representé", "representaste", "representó", "representamos", "representasteis", "representaron"],
        ["representaré", "representarás", "representará", "representaremos", "representaréis", "representarán"],
        ["representaría", "representarías", "representaría", "representaríamos", "representaríais", "representarían"],
        ["he representado", "has representado", "ha representado", "hemos representado", "habéis representado", "han representado"],
        ["había representado", "habías representado", "había representado", "habíamos representado", "habíais representado", "habían representado"],
        ["hube representado", "hubiste representado", "hubo representado", "hubimos representado", "hubisteis representado", "hubieron representado"],
        ["habré representado", "habrás representado", "habrá representado", "habremos representado", "habréis representado", "habrán representado"],
        ["habría representado", "habrías representado", "habría representado", "habríamos representado", "habríais representado", "habrían representado"],
        ["represente", "representes", "represente", "representemos", "representéis", "representen"],
        ["representara", "representaras", "representara", "representáramos", "representarais", "representaran"],
        ["representare", "representares", "representare", "representáremos", "representareis", "representaren"],
        ["haya representado", "hayas representado", "haya representado", "hayamos representado", "hayáis representado", "hayan representado"],
        ["hubiera representado", "hubieras representado", "hubiera representado", "hubiéramos representado", "hubierais representado", "hubieran representado"],
        ["hubiere representado", "hubieres representado", "hubiere representado", "hubiéremos representado", "hubiereis representado", "hubieren representado"],
    ]
    for (_, mood, tense), row in zip(SCOPES, rows):
        found[("representar", mood, tense)] = row
    return found
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-renunciar-requerir/checkpoints.jsonl").read_text().splitlines()]
