#!/usr/bin/env python3
"""Verify that files outside the mantener/marcar/matar/mediar batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-mantener-mediar-preserve.json").read_text())
