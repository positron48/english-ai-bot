#!/usr/bin/env python3
"""Evidence checks for the mantener/marcar/matar/mediar review batch."""
...
BASE = Path("/tmp/grammar-es-verbs-mantener-mediar-baseline")
LEMMAS = {
    "mantener": "c33a9e86945249c11081de2e",
    "marcar": "bdcee8ecc4dca61cb8fbf5b9",
    "matar": "d73a0744fa24a6cb3dd6c6e3",
    "mediar": "73319a559990382c9cef3401",
}
SCOPES = [
...
def jehle_forms():
    ...
    rae_mediar = [
        ["medio", "medias", "media", "mediamos", "mediáis", "median"],
        ["mediaba", "mediabas", "mediaba", "mediábamos", "mediabais", "mediaban"],
        ["medié", "mediaste", "medió", "mediamos", "mediasteis", "mediaron"],
        ["mediaré", "mediarás", "mediará", "mediaremos", "mediaréis", "mediarán"],
        ["mediaría", "mediarías", "mediaría", "mediaríamos", "mediaríais", "mediarían"],
        ["he mediado", "has mediado", "ha mediado", "hemos mediado", "habéis mediado", "han mediado"],
        ["había mediado", "habías mediado", "había mediado", "habíamos mediado", "habíais mediado", "habían mediado"],
        ["hube mediado", "hubiste mediado", "hubo mediado", "hubimos mediado", "hubisteis mediado", "hubieron mediado"],
        ["habré mediado", "habrás mediado", "habrá mediado", "habremos mediado", "habréis mediado", "habrán mediado"],
        ["habría mediado", "habrías mediado", "habría mediado", "habríamos mediado", "habríais mediado", "habrían mediado"],
        ["medie", "medies", "medie", "mediemos", "mediéis", "medien"],
        ["mediara", "mediaras", "mediara", "mediáramos", "mediarais", "mediaran"],
        ["mediare", "mediares", "mediare", "mediáremos", "mediareis", "mediaren"],
        ["haya mediado", "hayas mediado", "haya mediado", "hayamos mediado", "hayáis mediado", "hayan mediado"],
        ["hubiera mediado", "hubieras mediado", "hubiera mediado", "hubiéramos mediado", "hubierais mediado", "hubieran mediado"],
        ["hubiere mediado", "hubieres mediado", "hubiere mediado", "hubiéremos mediado", "hubiereis mediado", "hubieren mediado"],
    ]
    for (_, mood, tense), values in zip(SCOPES, rae_mediar):
        found[("mediar", mood, tense)] = values
    return found
...
def main():
    ...
    checkpoints = [json.loads(line) for line in (
        ROOT / "docs/grammar-review/batches/2026-09-06-es-verbs-mantener-mediar/checkpoints.jsonl"
