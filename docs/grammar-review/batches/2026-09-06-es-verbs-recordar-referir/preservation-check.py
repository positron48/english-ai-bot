#!/usr/bin/env python3
"""Verify files outside the recordar/recuperar/reducir/referir batch are unchanged."""
...
SNAPSHOT = json.loads(Path("/tmp/grammar-es-verbs-recordar-referir-preserve.json").read_text())
