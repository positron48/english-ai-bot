...
COPY --from=builder /app/courses/english-grammar/word-sets-must-have.yaml ./data/english_word_sets_must_have.yaml
COPY --from=builder /app/courses/spanish-grammar/word-sets-must-have.yaml ./data/spanish_word_sets_must_have.yaml
